/**
 * Add photo to a scorpion — Phase 3b.
 *
 * Slim clone of app/tarantula/add-photo.tsx. Routes to
 * `uploadScorpionPhoto` from the 3a lib; backend writes the FK
...
import { uploadScorpionPhoto } from '../../src/lib/scorpions';

export default function AddScorpionPhotoScreen() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      await uploadScorpionPhoto(id, form);
      router.back();
    } catch (err: any) {
      const detail =
