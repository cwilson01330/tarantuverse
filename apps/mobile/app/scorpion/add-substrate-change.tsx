/**
 * Log substrate change for a scorpion — Phase 3b.
 *
 * Mirrors the tarantula substrate flow. The backend auto-denormalizes
 * the change date + type + depth onto the parent scorpion (see
...
import { createScorpionSubstrateChange } from '../../src/lib/scorpions';
...
export default function AddScorpionSubstrateChangeScreen() {
  ...
  const handleSave = async () => {
    ...
    try {
      setSaving(true);
      await createScorpionSubstrateChange(id, {
