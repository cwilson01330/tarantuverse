/**
 * Log feeding for a scorpion — Phase 3b.
 *
 ...
 * when the scorpion analytics + reminder surfaces ship.
 */
...
import { createScorpionFeeding } from '../../src/lib/scorpions';
...
export default function AddScorpionFeedingScreen() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await createScorpionFeeding(id, {
        fed_at: fedAt,
        food_type: foodType,
        accepted,
