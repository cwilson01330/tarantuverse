/**
 * Log molt for a centipede — Phase 3b.
 *
 * Centipedes count instars (typically 1-7). The screen prompts for the
 * new instar as a convenience — we don't currently update
 * centipede.current_instar here, but we capture it in notes so keepers
...
import { createCentipedeMolt } from '../../src/lib/centipedes';
import { toISODateLocal } from '../../src/utils/date';

export default function AddCentipedeMoltScreen() {
