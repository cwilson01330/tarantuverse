/**
 * Add photo to a whip spider — ADR-006 taxon #1.
 *
 * Mirror of the centipede add-photo screen. Routes to
 * `uploadWhipSpiderPhoto`; the backend writes the Photo row with only
 * `invert_id` set (consolidated surface).
 */
...
import { uploadWhipSpiderPhoto } from '../../src/lib/whip-spiders';

export default function AddWhipSpiderPhotoScreen() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      await uploadWhipSpiderPhoto(id, form);
      router.back();
    } catch (err: any) {
      const detail =
      ...
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.captionWrap}>
          ...
          <TextInput
            ...
            placeholder="Fresh molt, full grown, enclosure shot, etc."
