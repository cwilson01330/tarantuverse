...
SPECIES_DATA = [
    ...
    # ===================== TURTLES =====================
    {
        ...
        "uvb_required": True, "uvb_type": "T5_HO", "uvb_replacement_months": 12,
        "enclosure_type": None,
        "enclosure_min_adult": "AQUATIC — 40 gal minimum per adult (vet); 75+ gal recommended. Full dry basking dock; strong filtration.",
    ...
    },
    {
        ...
        "uvb_required": True, "uvb_type": "T5_HO", "uvb_replacement_months": 12,
        "enclosure_type": None,
        "enclosure_min_adult": "AQUATIC — 20 gal minimum (vet); 40 gal / 36x18 in preferred (floor area matters). Water depth 8-12 in with easy climb-outs.",
        "bioactive_suitable": False,
    ...
    # ===================== TORTOISES =====================
    {
        ...
        "enclosure_type": "terrestrial",
        "enclosure_min_adult": "Large heated OUTDOOR enclosure for adults with a heated shelter; not a tank animal long-term. Bury fencing 12-24 in (prolific tunneler).",
        "bioactive_suitable": False,
    ...
    },
    {
        ...
        "uvb_required": True, "uvb_type": "T5_HO", "uvb_replacement_months": 12,
        "enclosure_type": "terrestrial",
        "enclosure_min_adult": "Outdoor best when temps allow (bury fencing deep — avid digger/escaper); indoor ~4x2 ft minimum, larger preferred",
        "bioactive_suitable": True,
    ...
    # ===================== SALAMANDERS / NEWTS =====================
    {
        ...
        "uvb_required": False, "uvb_type": "not_required", "uvb_replacement_months": None,
        "enclosure_type": None,
        "enclosure_min_adult": "AQUATIC — 20 gal long minimum per adult (+10 gal each additional). Water depth >= body length. Secure lid.",
        "bioactive_suitable": False,
    ...
    },
    {
        ...
        "uvb_required": False, "uvb_type": "not_required", "uvb_replacement_months": None,
        "enclosure_type": None,
        "enclosure_min_adult": "SEMI-AQUATIC — ~10 gal for one, 20 gal for a pair/trio. Mandatory emergent land/haul-out; low water flow.",
        "bioactive_suitable": True,
    ...
    },
    {
        ...
        "enclosure_min_adult": "15-20 gal (24x12x12 in) for one adult; deep moisture-retentive substrate for burrowing + shallow water dish; secure lid",
        "bioactive_suitable": True,
