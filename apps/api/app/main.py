...
import app.routers.frogs as frogs  # Herpetoverse v1
...
print("[STARTUP] Registering frogs router (Herpetoverse v1)...")
app.include_router(frogs.router, prefix="/api/v1/frogs", tags=["frogs", "herpetoverse"])
