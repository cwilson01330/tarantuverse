...
def upgrade() -> None:
    ...
    sa.Column('care_level', sa.Enum('BEGINNER', 'INTERMEDIATE', 'ADVANCED', name='carelevel'), nullable=True),
    ...
    sa.Column('source', sa.Enum('BRED', 'BOUGHT', 'WILD_CAUGHT', name='source'), nullable=True),
