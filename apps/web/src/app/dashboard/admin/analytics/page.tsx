      ...
      {overview && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
          ...
          <AdminStatCard
            ...
            value={overview.total_collection ?? overview.total_tarantulas}
            subtitle={
              `${overview.total_inverts ?? 0} inverts · ` +
              `${overview.total_animals ?? 0} herps · ` +
              `${overview.total_colonies ?? 0} colonies`
            }
            icon={
              <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
