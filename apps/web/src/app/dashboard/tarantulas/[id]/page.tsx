        ...
        <div className="absolute inset-0 flex flex-col justify-end">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8 w-full">
            ...
            <div className="flex flex-wrap gap-2">
              {tarantula.sex && (
                <span
                  className="px-4 py-2 rounded-full bg-white/90 backdrop-blur-sm text-purple-900 text-sm font-semibold inline-flex items-center gap-1"
                  aria-label={`Sex: ${tarantula.sex}`}
                >
                  <span aria-hidden="true">
                    {tarantula.sex === 'male' ? '♂️' : tarantula.sex === 'female' ? '♀️' : '?'}
                  </span>{' '}
                  {tarantula.sex}
                </span>
              )}
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pl-12">
                            ...
                            <div>
                              ...
                              <span className={`inline-block px-3 py-1 rounded-full text-xs font-semibold capitalize ${
                                ...
                                pairing.outcome === 'unknown' ? 'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300' :
                                'bg-gray-100 text-gray-500 dark:bg-gray-800 dark:text-gray-500'
                              }`}>
                                {pairing.outcome ? pairing.outcome.replace('_', ' ') : 'Unknown'}
                              </span>
                            </div>
                          </div>
