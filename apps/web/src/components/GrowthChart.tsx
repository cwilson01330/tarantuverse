    ...
    <div className="bg-white rounded-lg shadow p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="bg-gray-50 rounded-lg p-3">
          <div className="text-xs text-gray-600 mb-1">Total Molts</div>
        ...
        {data.average_days_between_molts && (
          <div className="bg-gray-50 rounded-lg p-3">
            <div className="text-xs text-gray-600 mb-1">Avg Days Between</div>
            <div className="text-2xl font-bold text-gray-900">
        ...
        {data.total_weight_gain && (
          <div className="bg-gray-50 rounded-lg p-3">
            <div className="text-xs text-gray-600 mb-1">Weight Gain</div>
        ...
        {data.total_leg_span_gain && (
          <div className="bg-gray-50 rounded-lg p-3">
            <div className="text-xs text-gray-600 mb-1">Size Gain</div>
      ...
      {(data.growth_rate_weight || data.growth_rate_leg_span) && (
        <div className="border-t pt-4 flex flex-wrap gap-4 text-sm">
          {data.growth_rate_weight && (
            <div>
              <span className="text-gray-600">Weight Growth Rate:</span>{" "}
          ...
          {data.growth_rate_leg_span && (
            <div>
              <span className="text-gray-600">Size Growth Rate:</span>{" "}
          ...
          {data.days_since_last_molt !== undefined && (
            <div>
              <span className="text-gray-600">Days Since Last Molt:</span>{" "}
              <span className="font-semibold">{data.days_since_last_molt}</span>
            </div>
          )}
        </div>
      )}
