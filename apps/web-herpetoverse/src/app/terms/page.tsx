      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              You may stop using the Service at any time and may delete your account at <Link href="/app/settings" className="text-emerald-600 dark:text-emerald-400 hover:underline">/app/settings</Link>. Deletion is permanent and irreversible. Before deleting, you may export your data from <Link href="/app/settings" className="text-emerald-600 dark:text-emerald-400 hover:underline">Settings → Data Export</Link>.
            </p>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
      ...
      <footer className="bg-gray-100 dark:bg-gray-800 py-8 mt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-gray-600 dark:text-gray-400">
          ...
          <div className="mt-4 space-x-4">
            ...
            <Link href="/terms" className="hover:text-emerald-600 dark:hover:text-emerald-400">Terms of Service</Link>
