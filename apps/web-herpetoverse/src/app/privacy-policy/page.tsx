...
// Placement and brand-styling notes: see comment in /terms/page.tsx.
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-3">
              <Link href="/login" className="px-4 py-2 text-gray-700 dark:text-gray-300 hover:text-emerald-600 dark:hover:text-emerald-400 font-medium transition">
                Login
              </Link>
              <Link href="/register" className="px-6 py-2 bg-gradient-to-r from-emerald-600 to-amber-700 text-white rounded-lg hover:shadow-lg transform hover:scale-105 transition font-medium">
                Get Started
              </Link>
            </div>
          </div>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              We retain your information for as long as your account is active or as needed to provide the Service. If you delete your account through <Link href="/app/settings" className="text-emerald-600 dark:text-emerald-400 hover:underline">/app/settings</Link>, we permanently remove your personal data within thirty (30) days, except where we are required to keep it longer to comply with legal, tax, regulatory, or security obligations, to resolve disputes, or to enforce our agreements.
            </p>
            <p className="text-gray-700 dark:text-gray-300">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4 text-gray-700 dark:text-gray-300 space-y-2">
              <li><strong>Access and portability:</strong> download your data from <Link href="/app/settings" className="text-emerald-600 dark:text-emerald-400 hover:underline">Settings → Data Export</Link> in JSON, CSV, or a full ZIP including photos.</li>
              <li><strong>Correction:</strong> edit your profile, animals, logs, and other records from the dashboard.</li>
              <li><strong>Deletion:</strong> permanently delete your account and personal data at <Link href="/app/settings" className="text-emerald-600 dark:text-emerald-400 hover:underline">/app/settings</Link>.</li>
              <li><strong>Visibility:</strong> set your collection to private or public in Settings.</li>
              <li><strong>Notifications:</strong> manage push, email, and in-app notifications from <Link href="/app/settings" className="text-emerald-600 dark:text-emerald-400 hover:underline">Settings → Notifications</Link>.</li>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center text-gray-600 dark:text-gray-400 text-sm">
            ...
            <div className="flex justify-center gap-4 flex-wrap">
              ...
              <span>&bull;</span>
              <Link href="mailto:support@tarantuverse.com" className="hover:text-emerald-600 dark:hover:text-emerald-400">
                Contact
              </Link>
              <span>&bull;</span>
